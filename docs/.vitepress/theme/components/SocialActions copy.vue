...
<template>
  <div class="social-actions">
    ...
    <button
      v-if="showComments"
      @click="handleComment"
      :title="`Commenter ${tooltipSubject}`"
      class="social-btn comment"
    >
      Comment
    </button>
    ...
    <button
      v-if="showShare"
      @click="handleShare"
      :title="`Partager ${tooltipSubject}`"
      class="social-btn share"
    >
      Share
    </button>

    <!-- Bouton "review" ajouté -->
    <button
      v-if="showReview"
      @click="handleReview"
      :title="`Noter ${tooltipSubject}`"
      class="social-btn review"
    >
      Review
    </button>
  </div>
...
// Fonctions de gestion des actions (conserver le comportement d'origine)
const handleLike = () => {
  console.log("Action Like déclenchée")
}

const handleComment = () => {
  console.log("Action Comment déclenchée")
}

const handleShare = () => {
  console.log("Action Share déclenchée")
}

const handleReview = () => {
  console.log("Action Review déclenchée")
}
</script>
...
/* Styles d'origine pour chaque action */
.like {
...
/* Style similaire pour le bouton "review" (vous pouvez l'ajuster si besoin) */
.review {
