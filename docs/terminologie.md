...
### Autophagie {#autophagie}
 Processus physiologique par lequel une cellule dégrade et recycle ses propres composants internes, tels que des protéines mal repliées, des organites endommagés ou des agrégats protéiques.
 <ReturnLink /> 
...
### IMC {#IMC}
L'Indice de Masse Corporelle (IMC) est une mesure utilisée pour évaluer la corpulence d'une personne en fonction de son poids et de sa taille. Il se calcule en divisant le poids (en kilogrammes) par le carré de la taille (en mètres) :
